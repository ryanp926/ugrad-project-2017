...
<body>
    <div class="b-content hide-footer">
        <form id="form_4" class="fr-widget fr-form fr-wf fr_form_4 fr-link" method="POST" action="insertsubscriber.php" data-fr-collect-data="insertsubscriber.php" enctype="multipart/form-data" target="_blank">
         ...
         --><div id="input_11" class="fr-widget fr-input fr-wf fr_input_11"> <input type="email" class="fr_input_11" placeholder="Your email address" name="EMAIL">
            </div><!--
         --><div id="input_11" class="fr-widget fr-input fr-wf fr_input_11"> <input type="text" required class="fr_input_11" placeholder="Your zipcode" name="ZIPCODE">
            </div><!--
         --><!--
         ...
         -->
            ...
            <div class="fr-form-submit-popup js-fr-success-form-submit">
                ...
                <h6>Thank you! hello</h6>

                <?php session_start(); echo $_SESSION["TEST"]; echo "hello" . "Form has been successfully sent!" ?>
            </div>
